...
export function SectionList({
  ...
  const createMutation = useCreateSection(questionnaireId, { onSuccess: () => setIsCreateOpen(false) })
  const updateMutation = useUpdateSection(questionnaireId, { onSuccess: () => setEditingId(null) })
  const deleteMutation = useDeleteSection(questionnaireId, { onSuccess: () => setDeletingId(null) })
