...
export function useSubmitQuestionForm({
  ...
  const createMutation = useCreateQuestion(questionnaireId, { onSuccess })
  const updateMutation = useUpdateQuestion(questionnaireId, { onSuccess })
  const createOptionMutation = useCreateOption(questionnaireId)
  const updateOptionMutation = useUpdateOption(questionnaireId)
  const deleteOptionMutation = useDeleteOption(questionnaireId)
