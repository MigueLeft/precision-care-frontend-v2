...
export function RangeInterpretationEditor({
  ...
  const createMutation = useCreateRangeInterpretation(intakeId, {
    onSuccess: () => setForm(EMPTY_FORM),
  })
  const updateMutation = useUpdateRangeInterpretation(intakeId, {
    onSuccess: () => {
      setEditingId(null)
      setForm(EMPTY_FORM)
    },
  })
  const deleteMutation = useDeleteRangeInterpretation(intakeId)
